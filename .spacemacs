...
you should place you code here."
  ...
  ;; [ENV]<var>@
  ;;
  (setq gio-assert-macro [?y ?y ?p ?k ?W ?d ?a ?W ?B ?P ?a ?  escape ?B ?h ?x ?i ?G ?I ?O ?_ ?A ?S ?S ?E ?R ?T ?_ ?E ?Q ?U ?A ?L ?_ escape ?E ?a ?_ ?D ?S ?2 escape ?a ?\( escape ?l ?x ?A ?\) ?\; escape ?j ?d ?a ?W ?B ?i ?\[ ?E ?N ?V ?\] escape ?B])
